...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String authToken) {
    	...
    	val principal = DetailedUser.createBuilder()
    		.username(claims.getSubject())
    		.authorities(authorities)
    		.firstName(claims.get(JwtFields.FIRSTNAME_KEY, String.class))
    		.lastName(claims.get(JwtFields.LASTNAME_KEY, String.class))
    		.email(claims.get(JwtFields.EMAIL_KEY, String.class))
    		.language(claims.get(JwtFields.LOCALE_KEY, String.class))
    		.scope(claims.get(JwtFields.SCOPE_KEY, String.class))
    		.build();
